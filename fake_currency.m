...
%[I2, rect] = imcrop(a);
a2_tr = imcrop(a,[2218.5 204.5 535 521]);  
b2_tr = imcrop(p,[2218.5 204.5 535 521]);  


a2_str = imcrop(a,[1766.5 4.5 63 1096]);   
p2_str = imcrop(p,[1666.5 4.5 63 1096]);  
...
if (co>=0.5 && countReal == 1 && countFake ~= 1 )
    disp ('correlevance of  mujib > 0.5');
